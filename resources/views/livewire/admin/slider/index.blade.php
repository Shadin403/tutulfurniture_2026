                ...
                <div class="text-white shadow-lg card bg-gradient-dark">
                    <div class="p-4 card-body">
                        <div class="row align-items-center">
                            <div class="col">
                                <h2 class="mb-0 text-white fw-bold">ALL Slider List</h2>

                            </div>
                            <div class="col-auto">
                                <a href="{{ route('admin.slider.create') }}" class="px-4 py-2 shadow-sm btn btn-light"
                                    wire:navigate>
                ...
                <div class="shadow-sm card">
                    <div class="p-3 card-body">
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
                                    <p class="mb-0 text-sm text-uppercase font-weight-bold text-muted">Total sliders
                                    </p>
                                    <h5 class="mb-0 font-weight-bolder" id="total-cars">{{ $sliders_count }}</h5>
                                </div>
                            </div>
                ...
                <div class="shadow-sm card">
                    <div class="p-3 card-body">
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
                                    <p class="mb-0 text-sm text-uppercase font-weight-bold text-muted">Available</p>
                                    <h5 class="mb-0 font-weight-bolder" id="available-cars">{{ $sliders->count() }}</h5>
                                </div>
                            </div>
                            <div class="col-4 text-end">
                                <div
                    ...
                    <div class="mb-3 col-md-6 mb-md-0">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control border-start-0 ps-0" name="search"
                                id="searchCars" placeholder="Search cars by name, slider or model..." value="">
                        ...
                        @forelse ($sliders as $index => $slider)
                            <tbody>
                                <tr wire:key="{{ $slider->id }}">
                                    ...
                                    <td>
                                        <p class="mb-0 text-sm">{{ $slider->title }}</p>
                                    </td>
                                    <td>
                                        <img height="50px" width="50px"
                                            src="{{ asset('storage/uploads/sliders/' . $slider->image) ?? asset('admin/img/no-image.png') }}"
                                            alt="{{ $slider->name }}">
                                    </td>
                                    <td>
                                        <p class="mb-0 text-sm">{{ $slider->subtitle }}</p>
                                    </td>
                                    <td>
                                        @if ($slider->status == 1)
                                            <div
                                                class="text-center icon icon-shape bg-gradient-success shadow-success rounded-circle">
                                                <i style="color: green" class="text-lg bi bi-check-circle opacity-10"
                                                    aria-hidden="true"></i>
                                        ...
                                        @else
                                            <div
                                                ...
                                                <i style="color: red" class="text-lg bi bi-x-circle opacity-10"
                                                    aria-hidden="true"></i>
                                    ...
                                    <td>
                                        ...
                                        <p class="mb-0 text-sm">{{ $slider->tagline }}</p>
                                    </td>
                                    <td class="text-end pe-4">
                                        <a href="{{ route('admin.slider.edit', $slider->id) }}" wire:navigate.prefetch
                                        ...
                                        <a onclick="confirmDelete({{ $slider->id }})"
        ...
        function confirmDelete(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    Livewire.dispatch('deleteslider', {
                        id
                    });
                    Swal.fire(
                        'Deleted!',
