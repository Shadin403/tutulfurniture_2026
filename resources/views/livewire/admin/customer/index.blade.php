                ...
                <div class="text-white shadow-lg card bg-gradient-dark">
                    <div class="p-4 card-body">
                        <div class="row align-items-center">
                            <div class="col">
                                <h2 class="mb-0 text-white fw-bold">ALL Customer List</h2>
                                <p class="mb-0 text-light">Manage your Customer inventory </p>
                            </div>
                            {{-- <div class="col-auto">
                                <a href="{{ route('admin.subCategory.create') }}"
                                    class="px-4 py-2 shadow-sm btn btn-light" wire:navigate>
                        ...
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
                                    ...
                                    <h5 class="mb-0 font-weight-bolder" id="total-cars">{{ $customers_count }}
                                    </h5>
                                </div>
                            </div>
                ...
                <div class="row align-items-center">
                    <div class="mb-3 col-md-6 mb-md-0">
                        <div class="input-group" wire:ignore.self>
                            ...
                            <input type="text" class="form-control border-start-0 ps-0" name="search"
                                wire:model.live.debounce.300ms="search" id="searchCars"
                                placeholder="Search Customers by name, email, name, role...">
                    ...
                    <div class="col-md-6">
                        <div class="d-flex justify-content-md-end">
                            ...
                            <div class="btn-group" wire:scroll-prevnet>
                                <button type="button" class="btn btn-outline-secondary dropdown-toggle"
                                    data-bs-toggle="dropdown" id="sortButton">
                                    <i class="bi bi-sort-down me-1"></i> <span
                                        id="current-sort">{{ $sortBy }}</span>
                                </button>
                                <ul class="dropdown-menu">
                                    <li wire:click="selectSort('Newest')"
                                        style="@if ($sortBy == 'Newest') background: slategray; @endif cursor:pointer;">
                                        <a class="dropdown-item sort-option">Newest
                                        </a>
                                    </li>
                                    <li wire:click="selectSort('Oldest')"
                                        style="@if ($sortBy == 'Oldest') background: slategray; @endif cursor:pointer;">
                                        <a class="dropdown-item sort-option">Oldest
                                        </a>
                                    </li>
                                    <li wire:click="selectSort('Name(A-Z)')"
                                        style="@if ($sortBy == 'Name(A-Z)') background: slategray; @endif cursor:pointer;">
                                        <a class="dropdown-item sort-option">Name(A-Z)</a>
                                    </li>
                                    <li wire:click="selectSort('Name(Z-A)')"
                                        style="@if ($sortBy == 'Name(Z-A)') background: slategray; @endif cursor:pointer;">
                                        <a class="dropdown-item sort-option">Name(Z-A)</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        @forelse ($customers as $index => $customer)
                            <tbody>
                                <tr wire:key="{{ $customer->id }}">
                                    ...
                                    <td class="ps-4">
                                        <p class="mb-0 text-sm">Customer-{{ $customer->id }}</p>
                                    </td>
                                    <td>
                                        <p class="mb-0 text-sm">{{ $customer->name }}</p>
                                    </td>
                                    <td>
                                        <p class="mb-0 text-sm">{{ $customer->email }}</p>
                                    </td>
                                    <td>
                                        <p class="mb-0 text-sm">{{ $customer->mobile }}</p>
                                    </td>
                                    <td>
                                        {{ $customer->addresses->first()->address ?? 'No Address' }}
                                    </td>
                                    {{-- <td class="text-end pe-4">
                                        <a wire:navigate href="{{ route('admin.subCategory.edit', $customer->id) }}"
                                        ...
                                        <a onclick="confirmDelete({{ $customer->id }})"
