                ...
                <div class="text-white shadow-lg card bg-gradient-dark">
                    <div class="p-4 card-body">
                        <div class="row align-items-center">
                            <div class="col">
                                <h2 class="mb-0 text-white fw-bold">ALL Sub-Category List</h2>
                                <p class="mb-0 text-light">Manage your Sub-Category inventory </p>
                            </div>
                            <div class="col-auto">
                        ...
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
                                    ...
                                    <h5 class="mb-0 font-weight-bolder" id="total-cars">{{ $sub_categories_count }}
                                    </h5>
                                </div>
                            </div>
                        ...
                        @forelse ($sub_categories as $index => $category)
                            <tbody>
                                <tr wire:key="{{ $category->id }}">
                                    ...
                                    <td class="ps-4">
                                        <p class="mb-0 text-sm">Category-{{ $category->category_id }}</p>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <img height="50px" width="50px"
                                            src="{{ asset('storage/uploads/sub-categories/' . $category->image) ?? asset('admin/img/no-image.png') }}"
                                            alt="{{ $category->name }}">
                                    </td>
                                    <td>
                                    ...
                                    <td class="text-end pe-4">
                                        <a wire:navigate href="{{ route('admin.subCategory.edit', $category->id) }}"
