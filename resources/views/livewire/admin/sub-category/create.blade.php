        ...
        <div class="overflow-hidden border-0 shadow-lg card rounded-3">
            <div class="p-4 border-0 card-header bg-gradient-primary">
                <h4 class="mb-0 text-white">
                    <i class="bi bi-car-front me-2"></i> Create slug Information
                </h4>
            </div>
            <div class="p-4 card-body">
                <form wire:submit.prevent="createSubCategory" class="needs-validation">
                    <div class="mb-4 row">
                        <div class="col-md-12">
                    ...
                    <div class="row g-4">
                            ...
                            <div class="form-floating">
                                ...
                                <select class="form-select" wire:model='category_id'>
                                    ...
                                    @foreach ($categories as $category)
                                        <option value="{{ $category->id }}" class="text-info">Id:{{ $category->id }}
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control" wire:model='slug' id="slug"
                                        name="slug" value="{{ old('slug') }}" placeholder="Enter car slug">
                                    <label for="slug"><i class="bi bi-briefcase me-1"></i>Slug</label>
                        ...
                        <div class="mt-5 mb-4 row">
                            <div class="col-md-12">
                                <div class="mb-3 d-flex align-items-center">
                                    ...
                                    <h5 class="mb-0 text-primary fw-bold">slug Details & Specifications</h5>
                                </div>
                                <hr class="mt-0">
                            </div>
                        </div>
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-12">
                                <div class="form-floating">
                                    <textarea class="form-control" wire:model='description' id="description" name="description" style="height: 150px"
                                        placeholder="Enter long description">{{ old('description') }}</textarea>
                                    <label for="long_description"><i class="bi bi-file-text me-1"></i> Full
                                        Description</label>
