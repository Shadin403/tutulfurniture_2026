        ...
        <div class="overflow-hidden border-0 shadow-lg card rounded-3">
            <div class="p-4 border-0 card-header bg-gradient-primary">
                <h4 class="mb-0 text-white">
                    <i class="bi bi-car-front me-2"></i> Update Category Information
                </h4>
            </div>
            <div class="p-4 card-body">
                <form wire:submit.prevent="updateCategory" class="needs-validation">
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mt-2" id="imagepreview">
                                ...
                                @else
                                    <img src="{{ asset('storage/uploads/categories/' . $oldImage) }}"
