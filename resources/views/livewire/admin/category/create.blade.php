        ...
        <div class="overflow-hidden border-0 shadow-lg card rounded-3">
            <div class="p-4 border-0 card-header bg-gradient-primary">
                <h4 class="mb-0 text-white">
                    <i class="bi bi-car-front me-2"></i> Create Category Information
                </h4>
            </div>
            <div class="p-4 card-body">
                <form wire:submit.prevent="storeCategory" class="needs-validation">
                    <div class="mb-4 row">
                        <div class="col-md-12">
                    ...
                    <div class="row g-4">
                        <div class="col-md-6">
                            <div class="form-floating">
                                <input type="text" class="form-control" wire:model.live.debounce.1s='name'
                    ...
                    <div class="mt-5 mb-4 row">
                        <div class="col-md-12">
                            <div class="mb-3 d-flex align-items-center">
                                ...
                                <h5 class="mb-0 text-primary fw-bold">Category Details & Specifications</h5>
                            </div>
                            <hr class="mt-0">
                        </div>
                    </div>
                    ...
                    <div class="mt-5 row">
                        <div class="text-center col-12">
                            ...
                            <a href="{{ route('admin.all.categories') }}" wire:navigate
...
@push('scripts')
    <script>
        function initQuill() {
            ...
            const quillDescription = new Quill(quillEl, {
                theme: 'snow',
