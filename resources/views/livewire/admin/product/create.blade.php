...
<div>
    <div class="container mt-4">
        ...
        @endif
        @if ($errors->any())
            <div x-data="{ open: true }" class="position-fixed bottom-0 end-0 p-3" style="z-index: 1050">
                <div class="toast show bg-danger text-white" role="alert">
                    <div class="toast-header">
                        <strong class="me-auto">Error</strong>
                        <button @click="open = false" x-show="open==true" type="button" class="btn-close"
                            data-bs-dismiss="toast"></button>

                        <button @click="open = true" x-show="!open" type="button" class="btn-chevron-up"
                            aria-label="Open">
                        </button>
                    </div>
                    <div class="toast-body" x-show.transition="open">
                        <ul>
        ...
        <div class="overflow-hidden border-0 shadow-lg card rounded-3">
            <div class="p-4 border-0 card-header bg-gradient-primary">
                <h4 class="mb-0 text-white">
                    <i class="bi bi-box-seam me-2"></i> Create Product Information
                </h4>
            </div>
            <div class="p-4 card-body">
                <form wire:submit.prevent="save" class="needs-validation">
                    ...
                    <div class="row g-4">
                        <div class="col-md-6">
                            <div class="form-floating">
                                <input type="text" class="form-control @error('name') is-invalid @enderror"
                                    id="name" wire:model.live="name" placeholder="Enter Product name">
                        ...
                        <div x-cloak x-data="{ uploading: false, progress: 0 }" class="col-md-6"
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="file"
                                        ...
                                        id="gallery_images" wire:model="gallery_images" multiple accept="image/*">
                        ...
                        <div class="col-md-6">
                            <div class="form-floating">
                                <input type="number" step="0.01" class="form-control" id="discount_price"
                                    wire:model="discount_price" placeholder="Enter discount price">
                        ...
                        <div class="col-md-6">
                            <div class="form-floating">
                                <input type="time" class="form-control" id="discount_time"
                                    wire:model="discount_time" placeholder="Enter discount end time" readonly>
                    ...
                    <div x-data="{ open: false }">
                            ...
                            <div class="col-md-12">
                                <div class="mb-3 d-flex align-items-center">
                                    ...
                                    <h5 class="mb-0 text-primary fw-bold"
                                        @click="open = true ; if(open)$nextTick(() => $refs.details.scrollIntoView({  behavior: 'smooth'})), $refs.details.focus({preventScroll:false})">
                                        Product Details & Specifications</h5>
                                    <div class="ms-auto">
                                        <button type="button" class="btn btn-outline-primary btn-sm"
                                            @click="open = !open ; if(open)$nextTick(() => $refs.details.scrollIntoView({  behavior: 'smooth'})), $refs.details.focus({preventScroll:false})">
                                            <i class="bi bi-chevron-down me-1"></i>
                                            <span x-show="open">Hide</span>
                                            <span x-show="!open">Show</span> Details
                                        </button>
                                    </div>
                        ...
                        <div x-show="open" x-ref="details"x-transition>
                            <div class="row g-4">
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <textarea name="material" class="form-control" id="material" wire:model='material' cols="30" rows="8"
                                            placeholder="Enter Material"></textarea>
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        ...
                                        <label for="weight"><i class="bi bi-speedometer2 me-1"></i> Weight
                                            (kg)</label>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <p><i class="bi bi-info-circle me-1"></i> Short Description</p>
                                    <div class="form-floating">
                                        <div wire:ignore>
                                            <div id="quill-short-description" style="height: 150px;">
                                            </div>
                                        </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <input type="text" class="form-control" id="meta_title"
                                            wire:model="meta_title" placeholder="Enter meta title">
...
@push('scripts')
    <script>
        function initQuillEditor() {
            ...
            if (
                document.querySelector('#quill-short-description .ql-editor') ||
                document.querySelector('#quill-description .ql-editor')
            ) {
                return;
            }
