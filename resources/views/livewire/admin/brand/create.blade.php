        ...
        <div class="overflow-hidden border-0 shadow-lg card rounded-3">
            <div class="p-4 border-0 card-header bg-gradient-primary">
                <h4 class="mb-0 text-white">
                    <i class="bi bi-car-front me-2"></i> Create Brand Information
                </h4>
            </div>
            <div class="p-4 card-body">
                <form wire:submit.prevent="storeBrand" class="needs-validation">
                    <div class="mb-4 row">
                        <div class="col-md-12">
                    ...
                    <div class="row g-4">
                        <div class="col-md-6">
                            <div class="form-floating">
                                <input type="text" class="form-control" wire:model.lazy.1s='name' id="name"
...
@push('scripts')
    ...
    <script>
        function initQuillEditor() {
            ...
            if (
                document.querySelector('#quill-editor .ql-editor')
            ) {
                return;
            }
